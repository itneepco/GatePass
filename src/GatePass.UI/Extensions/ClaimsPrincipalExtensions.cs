...
public static class ClaimsPrincipalExtensions
{
    ...
    public static string GetExpiration(this ClaimsPrincipal claimsPrincipal)
        => claimsPrincipal.FindFirstValue(ClaimTypes.Expiration);
    ...
    public static Guid GetLocationId(this ClaimsPrincipal claimsPrincipal)
         => Guid.Parse(claimsPrincipal.FindFirstValue(ApplicationClaimTypes.LocationId));
